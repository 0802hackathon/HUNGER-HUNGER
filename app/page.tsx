        ...
        <section className="hero">
          ...
          <div className="hero-inner">
            <div className="hero-copy">
              ...
              <p>
                作り切れなかった構想と、実践的な題材を探す学習者。
                <br />
                応募も承認もなく、公開Repositoryから自由に始められます。
              </p>
        ...
        <section className="how-section">
          <div className="section-container">
            <div className="section-intro">
              ...
              <p>
                Projectの所有者は変わりません。学習者は自分のForkで自由に試し、
                追加開発した成果を元Projectへ関連付けて投稿できます。
              </p>
            </div>
            <div className="concept-grid">
              <article>
                <span className="concept-number">01</span>
                <div className="concept-symbol">⌘</div>
                <h3>残す</h3>
              ...
              <article className="concept-featured">
                ...
                <div className="concept-symbol">↗</div>
                <h3>ビヨンドする</h3>
                <p>気になるRepositoryを見つけたら、応募せず自分の環境で開発開始。</p>
              </article>
              <article>
